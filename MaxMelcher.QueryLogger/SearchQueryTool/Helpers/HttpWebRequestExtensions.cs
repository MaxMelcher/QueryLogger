...
namespace SearchQueryTool.Helpers
{
    public static class HttpWebRequestExtensions
    {
        ...
        public static void ApplySPOCredentials(this HttpWebRequest webRequest, CookieCollection spoAuthCookies)
        {
            if (spoAuthCookies != null)
            {
                webRequest.CookieContainer = new CookieContainer();

                foreach (Cookie cookie in spoAuthCookies)
                {
